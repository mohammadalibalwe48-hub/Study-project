...
export default function DashboardSidebar({
  ...
  return (
    <section className="w-full lg:w-96 shrink-0 liquid-glass-glow rounded-3xl p-6 flex flex-col gap-8 border border-white/15">
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-6">
          <div className="flex items-center gap-4 text-right">
            ...
            <div>
              <h4 className="text-xl font-display font-normal text-foreground">{profile?.full_name || 'طالب البكالوريا'}</h4>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">التحصيل والأداء</h4>

          <div className="grid grid-cols-2 gap-3">
            <div className="liquid-glass rounded-2xl p-4 flex flex-col justify-between border border-white/10">
        ...
        <div className="space-y-4 pt-4 border-t border-white/10">
          <h4 className="text-xl font-display text-foreground">قائمة الشرف والطلاب الأوائل</h4>
              ...
              {currentLeaderboard.slice(0, 3).map((item, idx) => (
                <div key={idx} className="liquid-glass rounded-2xl p-3.5 flex items-center justify-between border border-white/10">
                  <div className="flex items-center gap-3 text-right">
                    <span className={`h-8 w-8 rounded-full flex items-center justify-center font-display text-sm font-bold ${
